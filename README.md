...
但是呢
开发者一直没那个本事
所以开发者只能使用ai（我真觉得很难避免但是请原谅）
然后就是我等会会把Unlicense协议搬过来我准备放弃版权
我打算给项目存档了可能会以后再也不更新我这个只能说...才活了1个月吧我这个项目
希望呢大家看到我这个的时候还是可以多点点 stars 我喜欢
不想点就算了
    仅此
        开发者haiyanfurry为项目主力开发项目95%
    完全放弃版权提供给大家
        2026.4.28
        那个喜欢用ai的开发者haiyanfurry
```
