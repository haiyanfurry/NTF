...
FindFriend 是一款跨平台社交、定位、多媒体应用，核心使用 C99 开发，支持 Linux、Windows、macOS、Android、iOS 等平台。
...
# 创建构建目录
cd /home/haiyan/汇总
mkdir -p build/outputs/test
cd build/outputs/test
...
| 文档 | 内容说明 |
|------|---------|
| [docs/CORE_INTERFACE.md](docs/CORE_INTERFACE.md) | 核心接口 API 详解 |
...
3. 阅读 [docs/CORE_INTERFACE.md](docs/CORE_INTERFACE.md) 查看 API 文档
4. 使用 CLI 工具测试各个模块
...
- 查看 `docs/` 目录下的完整文档
- 使用 `./build/outputs/test/bin/FindFriendCLI help` 查看 CLI 命令
